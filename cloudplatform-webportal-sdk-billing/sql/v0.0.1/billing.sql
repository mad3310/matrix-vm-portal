...
CREATE TABLE `MATRIX_BILLING_BASE_PRICE` (
  ...
  `TYPE` tinyint(4) DEFAULT NULL COMMENT '计费类型：0-基础价格，1-阶梯，2-线性',
...
CREATE TABLE `MATRIX_BILLING_ORDER` (
  ...
  `DISCOUNT_PRICE` decimal(30,3) DEFAULT NULL COMMENT '折扣价',
...
CREATE TABLE `MATRIX_BILLING_ORDER_DETAIL` (
  `ID` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '订单详情表主键',
  `ORDER_ID` bigint(20) unsigned DEFAULT NULL COMMENT '订单主表主键',
...
CREATE TABLE `MATRIX_BILLING_SUBSCRIPTION` (
  ...
  `HCLUSTER_ID` bigint(20) unsigned DEFAULT NULL COMMENT '机房机群ID',
  `CHARGE_TYPE` tinyint(4) DEFAULT NULL COMMENT '计费类型：0-包年包月，1-按量',
  `ORDER_NUM` int(10) DEFAULT NULL COMMENT '购买数量',
