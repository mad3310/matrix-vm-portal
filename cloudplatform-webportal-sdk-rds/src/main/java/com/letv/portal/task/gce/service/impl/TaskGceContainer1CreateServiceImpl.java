...
public class TaskGceContainer1CreateServiceImpl extends BaseTask4GceServiceImpl implements IBaseTaskService{
	...
	public TaskResult execute(Map<String, Object> params) throws Exception {
		...
		map.put("dataNodeName", containers.get(0).getContainerName());
		map.put("dataNodeIp", containers.get(0).getHostIp());
		map.put("dataNodeExternalPort", "28934");
		
		String result = this.gcePythonService.createContainer1(map,nodeIp1,cluster.getAdminUser(),cluster.getAdminPassword());
