...
function updateResourceData() {
	...
	$.ajax({ 
		...
		url : queryUrlBuilder("/monitor/rds/node/galera/list",queryCondition),
		...
		success : function(data) {
			...
			for (var i = 0, len = array.length; i < len; i++) {
				...
				td.push("<td>"+dataErrorFilter(array[i].wsrepFlowControlPaused)+"</td>");
				td.push("<td>"+dataErrorFilter(array[i].wsrepFlowControlRecv)+"</td>");
				td.push("<td>"+dataErrorFilter(array[i].wsrepFlowControlSent)+"</td>");
				td.push("<td>"+dataErrorFilter(array[i].wsrepLocalAbort)+"</td>");
				td.push("<td>"+dataErrorFilter(array[i].wsrepLocalFail)+"</td>");
				td.push("<td>"+dataErrorFilter(array[i].wsrepLocalReplays)+"</td>");
				td.push("<td>"+dataErrorFilter(array[i].wsrepRecBytes)+"</td>");
				td.push("<td>"+dataErrorFilter(array[i].wsrepRepBytes)+"</td>");
				td.push("<td>"+dataErrorFilter(array[i].wsrepReceived)+"</td>");
				td.push("<td>"+dataErrorFilter(array[i].wsrepReplicated)+"</td>");
