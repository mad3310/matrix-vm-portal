			...
			<div class="widget-body">
				<div class="widget-main no-padding">
					...
					<thead class="monitor-table-headr-group">
						<tr class="header-one"> 
							<th colspan=2 >服务器</th>
							<th colspan=2>innodb_buffer_</th>
							<th colspan=4>innodb_rows_</th>
						</tr>
						<tr class="header-two">
							<th  class="table-head-sort" target-data="HOST_IP">主机</th>
							<th>标签</th>
							<th  class="table-head-sort" target-data="INNODB_BUFFER_POOL_SIZE">_pool_size</th>
							<th  class="table-head-sort" target-data="INNODB_BUFFER_READ_HITS">_read_hits</th>
							<th  class="table-head-sort" target-data="INNODB_ROWS_READ">_read</th>
							<th  class="table-head-sort" target-data="INNODB_ROWS_INSERT">_insert</th>
							<th  class="table-head-sort" target-data="INNODB_ROWS_UPDATE">_update</th>
							<th  class="table-head-sort" target-data="INNODB_ROWS_DELETE">_delete</th>
						</tr>
					</thead>
						<tbody id="tby">
						</tbody>
...
<!-- /.page-content-area -->
<script src="${ctx}/static/scripts/pagejs/rds/rds_monitor_node_innodb.js"></script>