	...
	<div class="row">
		<div class="widget-box widget-color-blue ui-sortable-handle col-xs-12">
			<div class="widget-header">
				<h5 class="widget-title">任务流列表</h5>
		...
		<div class="modal fade" id="create-job-stream-modal" tabindex="-1" aria-labelledby="myModalLabel" style="margin-top:157px">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<select class="chosen-select" name="taskType" id="taskType" data-placeholder="请选择业务类型">
										...
										<option value="CBASE">CBASEs</option>
