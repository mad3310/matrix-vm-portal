...
<div class="page-content-area">
		...
		<div class="row">
			<div class="col-sm-12 col-xs-12 ">
				<form>
					...
					<div class="col-sm-1">
						<button class="pull-right btn btn-sm btn-primary btn-search" id="refresh-data"
							type="button" onclick="refreshChartForSelect()">
	...
	<!-- /.page-header -->
	<div class="row">
		<div id="monitor-option" class="col-md-12 col-sm-12">
			<div id="monitor-view" class="row"></div>
			<!-- <div class="space-24"></div> -->
			<div id="monitor-view-demo" name="monitor-view" class="col-md-12 col-sm-12 widget-container-col ui-sortable hide ui-sortable-disabled">
