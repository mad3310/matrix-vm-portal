package com.letv.lcp.cloudvm.model.storage;
...
public class VolumeCreateConf {
	...
	public String toString() {
		return "StorageCreateModel [region=" + region + ", size=" + size
				+ ", volumeTypeId=" + volumeTypeId + ", volumeSnapshotId="
				+ volumeSnapshotId + ", name=" + name + ", description="
