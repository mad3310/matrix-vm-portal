/*
 * @Title: MemCachedClient.java
 * @Package com.letv.mms.cache.client.memcached.client
 * @Description: TODO
 * @author chenguang 
 * @date 2012-12-18 下午6:18:51
 * @version V1.0
 *
...
import com.letv.mms.cache.impl.DefaultCacheImpl;
...
public class MemCachedClient {
	 ...
	 * 
	 * @param classLoader ClassLoader object.
	 * @param errorHandler IErrorHandler object.
	 */
	public MemCachedClient( ClassLoader classLoader, IErrorHandler errorHandler ) {
		this.classLoader  = classLoader;
	...
	/** 
	 * Creates a new instance of MemCacheClient but
	 * acceptes a passed in ClassLoader, IErrorHandler,
	 * and SockIOPool name.
	 * 
	 * @param classLoader ClassLoader object.
	 * @param errorHandler IErrorHandler object.
	 ...
	 */
	public MemCachedClient( ClassLoader classLoader, IErrorHandler errorHandler, String poolName ) {
		this.classLoader  = classLoader;
		this.errorHandler = errorHandler;
		this.poolName     = poolName;
		init();
	...
	/** 
	 * Sets an optional IErrorHandler.
	 * 
	 * @param errorHandler 
	 */
	...
	private boolean set( String cmdname, String key, Object value, Date expiry, Integer hashCode, boolean asString ) {
		...
		try {
			...
			else if ( NOTSTORED.equals( line ) ) 
			{
				...
				throw new IOException("writting key,occurs timeout error,the key is:"+key);
			}
		}
		catch ( IOException e ) {
...
//			}
			...
			sb.append("++++ exception thrown while trying to get object from cache for key: ").append(key)
			.append("The error reason is:").append(e.getMessage());
	 ...
	 * @throws java.io.IOException if io exception happens while reading from socket
	 */
