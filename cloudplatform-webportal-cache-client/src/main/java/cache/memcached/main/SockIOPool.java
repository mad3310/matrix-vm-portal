...
public class SockIOPool
{
	...
	private int socketConnectTO = 1000 * 3; // default timeout of socket
											// connections
	@SuppressWarnings("unused")
	private static int recBufferSize = 128;//接受数据的缓冲大小
...
//			返回非一致性的sock
	...
	private long getHash(String key, Integer hashCode)
	{
		...
		if (hashCode != null)
		{
//如果hashcode不为空,返回hashcode的long值  如果为空,返回默认的hash值			
