package com.letv.lcp.openstack.service.erroremail.impl;
...
@Service
public class ErrorEmailServiceImpl implements IErrorEmailService {
	...
	@Override
	public void sendErrorEmail(ErrorMailMessageModel model){
		sendErrorEmail(model.toMap());
	}
