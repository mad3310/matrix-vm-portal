...
import com.letv.lcp.openstack.model.compute.impl.LocalVmResource;
 ...
 */
@Service
public class LocalVmServiceImpl implements ILocalVmService {

    @Autowired
    private ICloudvmServerService cloudvmServerService;

    @Autowired
    private ILocalRegionService regionQueryService;
