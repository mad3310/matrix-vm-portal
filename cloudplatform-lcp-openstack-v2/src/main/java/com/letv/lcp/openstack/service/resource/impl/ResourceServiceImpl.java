...
import com.letv.lcp.openstack.model.compute.impl.FlavorResourceImpl;
...
import com.letv.lcp.openstack.model.network.impl.SubnetResourceImpl;
...
import com.letv.lcp.openstack.model.storage.impl.VolumeSnapshotResourceImpl;
...
import com.letv.lcp.openstack.service.task.rule.PingRuleCreateTask;
import com.letv.lcp.openstack.service.task.rule.RuleCreateTask;
import com.letv.lcp.openstack.service.task.rule.SshRuleCreateTask;
...
import com.letv.lcp.openstack.util.tuple.Tuple3;
...
//        floatingIPApi.addToServer(floatingIP.getIp(), vmId);
    ...
    public void renameVm(NovaApi novaApi, long userVoUserId, String region, String vmId, String name) throws OpenStackException {
        ...
        IVmSyncService vmSyncService = OpenStackServiceImpl.getOpenStackServiceGroup().getVmSyncService();
