...
<!-- <div class="content-right" data-spm="2"> -->
    <div class="bread-crumb">
        <span class="item"><a href="#" data-spm-anchor-id="5176.788314868.2.1">云数据库RDS</a></span>&nbsp;&gt;&nbsp;<span class="data-spm-click" data-id="2-1-6">用户连接不上数据库</span>
    </div>
    <h2 style="text-align: center;color: #333;font-size: 18px;">用户连接不上数据库</h2>
    <div class="article-content">
        <p>
            <span style="text-transform:none;text-indent:0px;display:inline !important;font:14px/21px 微软雅黑,Microsoft YaHei;white-space:normal;float:none;letter-spacing:normal;color:rgb(0,0,0);word-spacing:0px;">1. </span>
...
如果没有此业务机器的ip地址，参考<a href="" class="help-createUser" data-spm-click="help-createUser.jsp">"创建用户流程"</a>；如果个人办公电脑登录问题，请参考<a href="" class="help-connect" data-spm-click="help-connect.jsp">"个人办公电脑怎么连接数据库"</a>相关设置。如下图:</span>
        ...
        <p>
            <span style="text-transform:none;text-indent:0px;display:inline !important;font:14px/21px 微软雅黑,Microsoft YaHei;white-space:normal;float:none;letter-spacing:normal;color:rgb(0,0,0);word-spacing:0px;">2. </span>
...
注意：如果是乐影公司、致新可能连接不上数据库，请联系客服，需要IDC添加访问权限。</span></p><br>
        <p>
            <span style="text-transform:none;text-indent:0px;display:inline !important;font:14px/21px 微软雅黑,Microsoft YaHei;white-space:normal;float:none;letter-spacing:normal;color:rgb(0,0,0);word-spacing:0px;">3. </span>连接其中一个数据库连接成功，连接本地127.0.0.1失败（mysql -uzhang_test03 -p -h127.0.0.1）<br>
