...
<!-- <div class="content-right" data-spm="2"> -->
    ...
    <div class="article-content">
        <p><span>1、在<span style="line-height:1.5;font-family:微软雅黑,Microsoft YaHei;font-size:10.5pt;">【未开通的产品与服务:】</span>中，选择GCE服务，点击购买按钮，进入GCE购买页面，如下图：</p>
        <p><img src="/static/img/help/gce-quick1.jpg"></p>
        <p><span>2、购买云引擎GCE，必填字段，<span style="line-height:1.5;font-family:微软雅黑,Microsoft YaHei;font-size:10.5pt;">【云应用名称】【可用区】【服务类型】【镜像】【数量】</span>如下图，红框为必填处：</p>
        <p><img src="/static/img/help/gce-crt1.jpg"></p>
        <p><span>3、购买成功后，GCE实例列表会列表显示您已购买的GCE实例，如下图：</span></p>
        <p><img src="${ctx}/static/img/help/gce-quick2.jpg"></p>
        <p>4、点选进入一个应用实例，可查看或配置以下几项：<span style="line-height:1.5;font-family:微软雅黑,Microsoft YaHei;font-size:10.5pt;">【应用详情】【版本管理】【服务日志】【系统资源监控】</span>要说明的一点，这里的实例，分应用实例和ngix代理实例，请注意区分，下图为应用实例：</span></p>
