	...
	<div class="article-content">
		<div class="markdown-body ng-scope" ui-view="doc"
			...
			<div id="doc" doc-preloader="isload"
				...
				<p>GCE的系统架构从逻辑上可分为三部分：管理系统、运行系统和扩展服务。这些系统全部搭建在乐视通用云的大规模分布式计算系统上。管理系统负责整个平台的管控，包括资源生产、状态监控、弹性调度、数据存储、提供管理接口等；运行系统负责为托管的网络应用提供路由、计算、网络资源以及运行所需的中间件（如Web服务容器、负载均衡等），运行系统实现了多层沙箱隔离机制，保障不同租户的计算资源和数据的安全性；扩展服务框架负责接入各种常用的分布式云服务，旨在减少开发者重复开发通用功能，提高开发效率，并提供统一的使用接口。示意图如下：</p>
				<p>
					<img
						src="${ctx}/static/img/help/product/5.png"
						alt="">
				</p>
				<ul>
					<li><p>调度中心</p>
				...
				<p>
					<img
						src="${ctx}/static/img/help/product/6.png"
						alt="">
				</p>
				<ul>
					<li><p>资源层沙箱</p>
