...
<div class="info-wrapper">
	<div class="introduce" data-spm="4" data-spm-max-idx="3">
		...
		<div class="intro">通用云应用引擎（以下简称GCE）是乐视云计算推出一款基于弹性扩展的网络应用托管平台
		，采用多层沙箱保护提供安全运行环境，并且整合多种软件开发常用的扩展服务，帮助开发者快速开发和部署
		应用程序，将开发者从系统运维、技术钻研等工作中解放出来，集中于核心业务的开发和运营。目前支持JAVA
		开发语言，后续会支持PHP、PYTHON、NODEJS等开发语言。</div>
	</div>
	...
	<div class="function" data-spm="6">
		...
		<div class="function-panel y-clear">
			...
			<div class="dispaly-4div">
				<h3 class="">自动伸缩</h3>
				<p class="">
					应用运行过程中，GCE通过判断负载情况自动伸缩它所使用的资源，伸缩过程不影响应用对外服务，也无需用户干预</p>
			</div>
			<div class="dispaly-4div">
				<h3 class="">监控和日志查询</h3>
