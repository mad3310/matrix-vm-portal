...
<!-- <div class="content-right" data-spm="2"> -->
    ...
    <div class="article-content">
        ...
        <p><span style="text-transform:none;text-indent:0px;display:inline !important;font:14px/21px 微软雅黑,Microsoft YaHei;white-space:normal;float:none;letter-spacing:normal;color:rgb(0,0,0);word-spacing:0px;">1.从cyberduck.io下载cyberduck客户端工具。</p>
...
双击该文件导入cyberduck。
    ...
    <p><span style="text-transform:none;text-indent:0px;display:inline !important;font:14px/21px 微软雅黑,Microsoft YaHei;white-space:normal;float:none;letter-spacing:normal;color:rgb(0,0,0);word-spacing:0px;">4. 填入连接信息,注意路径一定要填写：就是建好的实例名称，否则认证不通过,如下图：
    </p>
