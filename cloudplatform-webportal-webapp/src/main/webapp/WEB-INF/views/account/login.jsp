...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Letv webportal login</title>
		...
		<![endif]-->
		<link rel="stylesheet" href="${ctx}/static/ace/css/ace.onpage-help.css" />

		<!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->

		<!--[if lt IE 9]>
		<script src="${ctx}/static/ace/js/html5shiv.js"></script>
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							...
							<div class="position-relative">
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										...
										<!--注册和找回密码 <div class="toolbar clearfix">
											<div>
							...
							<div class="navbar-fixed-top align-right">
								<br />
								&nbsp;
								<a id="btn-login-dark" href="#">夜晚</a>
								&nbsp;
								<span class="blue">/</span>
								&nbsp;
								<a id="btn-login-blur" href="#">个性</a>
								&nbsp;
								<span class="blue">/</span>
								&nbsp;
								<a id="btn-login-light" href="#">白天</a>
								&nbsp; &nbsp; &nbsp;
							</div>
						</div>
					</div><!-- /.col -->
