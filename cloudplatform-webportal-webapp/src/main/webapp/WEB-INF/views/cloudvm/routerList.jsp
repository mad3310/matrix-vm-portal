	...
	<div class="row main-header overHidden"> <!-- main-content-header begin -->
		...
		<div class="col-xs-12 col-sm-12 col-md-6 hidden-xs">
			<div class="pull-right">
				...
				<button class="btn-primary btn btn-md" onclick="window.open('${ctx}/detail/routerCreate')">购买路由</button>
				</h5>
			</div>
		</div>
		<div class="">
			<div class="pull-left">
				<form class="form-inline" role="form">
					<div class="form-group col-xs-9 col-sm-10">
						<input  id="routerName" type="text" class="form-control" size="48" placeholder="请输入实例名称进行搜索">
					</div>
...
seajs.use("${ctx}/static/page-js/cloudvm/routerList/main");
