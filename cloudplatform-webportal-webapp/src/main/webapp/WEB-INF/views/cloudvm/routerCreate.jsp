...
<body>
					...
					<form id="monthPurchaseForm">
						<div role="tabpanel" class="tab-pane fade active in" id="year">
							<div class="col-sm-12 col-md-9">
								<dl class="bk-group">
									...
									<dd class="bk-group-detail">
										...
										<div>
											...
											<div class="bk-form-row">
													<label class="bk-form-row-name col-sm-2" style="padding-left: 0px;">路由名称：</label>
													<div class="col-sm-4 row">
														<input id="routerName" class="form-control" name="routerName" type="text">
													</div>
											</div>
										</div>
									</dd>
								...
								<dl class="bk-group">
									<dt class="bk-group-title">其他配置</dt>
									<dd class="bk-group-detail">
										<div class="bk-group-control"></div>
										<div>
											<div class="bk-form-row">
												<label class="bk-form-row-name">公网网关：</label>
												<div class="col-xs-12 col-sm-10 row">
													<div class="bk-form-row-li">
														<div class="bk-buttontab">
															<input name="enablePublicNetworkGateway" type="hidden" value="1">
							...
							<div class="bk-scope bk-items bk-mb4">
								...
								<div>
									<div class="bk-items-list">
										<ul>
											<li><span class="bk-items-item-name">区域：</span> <span class="bk-items-item-value" id="buy_region">--</span></li>
											<li><span class="bk-items-item-name">名称：</span> <span class="bk-items-item-value" id="buy_router_name">--</span></li>
											<li><span class="bk-items-item-name">公网网关：</span> <span class="bk-items-item-value" id= "buy_enable_public_network_gateway">开启</span></li>
										</ul>
									</div>
								</div>
	...
	<script type="text/javascript">
		...
		seajs.use("${ctx}/static/page-js/cloudvm/routerCreate/main");
	</script>
</body>
</html>
