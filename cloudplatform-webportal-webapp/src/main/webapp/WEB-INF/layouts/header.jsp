					...
					<ul
						...
						<li class="dropdown-content">
							<ul class="dropdown-menu dropdown-navbar">
								<li><a href="#"> <img
										src="${ctx}/static/ace/avatars/avatar.png" class="msg-photo"
								...
								<li><a href="#"> <img
										src="${ctx}/static/ace/avatars/avatar3.png" class="msg-photo"
								...
								<li><a href="#"> <img
										src="${ctx}/static/ace/avatars/avatar4.png" class="msg-photo"
								...
								<li><a href="#"> <img
										src="${ctx}/static/ace/avatars/avatar2.png" class="msg-photo"
								...
								<li><a href="#"> <img
										src="${ctx}/static/ace/avatars/avatar5.png" class="msg-photo"
