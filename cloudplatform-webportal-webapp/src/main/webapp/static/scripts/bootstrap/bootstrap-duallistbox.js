...
;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      filterTextClear: '所有选项',
      filterPlaceHolder: '过滤',
      moveSelectedLabel: '移动选中',
      moveAllLabel: '移动所有',
      removeSelectedLabel: '移动选中',
      removeAllLabel: '移动所有',
      ...
      infoText: '所有选项个数 {0}',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="label label-warning">过滤后</span> {0} from {1}', // when not all of the options are visible due to the filter
      infoTextEmpty: '没有选项',                                                        // when there are no options present in the list
