...
define(['controllers/app.controller'], function (controllerModule) {
  ...
  controllerModule.controller('RemoveSubnetModalCtrl', function (Config, HttpService,WidgetService,Utility,CurrentContext, $scope, $modalInstance,$timeout,$window, routerInfo) {
