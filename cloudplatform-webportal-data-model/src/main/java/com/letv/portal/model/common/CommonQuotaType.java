...
public enum CommonQuotaType implements IntEnum {
    CLOUDVM_VM(1, 5L, CommonQuotaModule.CLOUDVM, "云主机数量", "个"),
    CLOUDVM_CPU(2, 10L, CommonQuotaModule.CLOUDVM, "CPU", "核"),
    CLOUDVM_MEMORY(3, 20L, CommonQuotaModule.CLOUDVM, "内存", "GB"),
    CLOUDVM_VOLUME(4, 5L, CommonQuotaModule.CLOUDVM, "云硬盘数量", "块"),
    ...
    CLOUDVM_NETWORK(8, 2L, CommonQuotaModule.CLOUDVM, "VPC数量", "个"),
    CLOUDVM_SUBNET(9, 5L, CommonQuotaModule.CLOUDVM, "子网数量", "个"),
    CLOUDVM_ROUTER(10, 2L, CommonQuotaModule.CLOUDVM, "路由器数量", "个"),
