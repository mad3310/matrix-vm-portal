...
import com.letv.portal.proxy.IDbApplyStandardProxy;

@Component
public class DbApplyStandardProxyImpl extends BaseProxyImpl<DbApplyStandardModel> implements
		IDbApplyStandardProxy{
	
	private final static Logger logger = LoggerFactory.getLogger(DbApplyStandardProxyImpl.class);
	...
	public DbApplyStandardProxyImpl() {
