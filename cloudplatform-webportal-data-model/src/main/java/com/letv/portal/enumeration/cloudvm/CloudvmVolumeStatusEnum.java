 ...
 */
public enum CloudvmVolumeStatusEnum implements IntEnum {
    ...
    private CloudvmVolumeStatusEnum(Integer code) {
        this.code = code;
    }
    ...
    public static CloudvmVolumeStatusEnum[] matrixStatus = {NIL, DETTACHING};
}
