CREATE TABLE `WEBPORTAL_CLOUDVM_NETWORK_SEGMENT` (
  `ID` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
	...
	`PHYSICAL_NETWORK` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
	`SEGMENTATION_ID` char(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
